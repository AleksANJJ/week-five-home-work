/*export const data = [
    {id: 1, moviesData: "Ozark"},
    {id: 2, moviesData: "Snowpiercer"},
    {id: 3, moviesData: "Manifest"},
    {id: 4, moviesData: "Stranger Things"},
    {id: 5, moviesData: "Locke&key"},
    {id: 6, moviesData: "Outer Banks"},
    {id: 7, moviesData: "The Crown"},
    {id: 8, moviesData: "The Sinner"},
    {id: 9, moviesData: "Unorthodox"},
    {id: 10, moviesData: "Rain"},
]*/
export const data = [
